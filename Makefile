...
noisydev: dev0a dev0b dev0c dev0 dev00 dev1 dev2a dev2b dev3a dev4a dev4 dev4a dev5 devg dev6 devgrep
...
dev6:
	./pybred c.bred . --keep <src6.txt

dev7:
	./qbred c.bred . --keep <src7.txt

qdevgrep:
	./qbred c.bred . --keep <grep.c
